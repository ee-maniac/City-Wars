...
public class Database {
    ...
    private static final String dummyDatabaseFiller = """
            ...
            ('rangerShot', 'ordinary', 'ranger', 22, 1, 7, 0, 50, 100),
            ('rangerTrap', 'ordinary', 'ranger', 20, 1, 8, 0, 50, 100),
            ('rangerknife', 'ordinary', 'ranger', 20, 1, 9, 0, 50, 100),
            ('rangerMultishot', 'ordinary', 'ranger', 19, 3, 8, 0, 50, 100),
            ('warriorSlash', 'ordinary', 'warrior', 24, 1, 7, 0, 50, 100),
            ('warriorCharge', 'ordinary', 'warrior', 21, 2, 8, 0, 50, 100),
            ('warriorRevenge', 'ordinary', 'warrior', 21, 2, 9, 0, 50, 100),
            ('warriorSpear', 'ordinary', 'warrior', 28, 1, 8, 0, 50, 100),
            ('sorcererFireball', 'ordinary', 'sorcerer', 23, 7, 3, 0, 50, 100),
            ('sorcererFrost', 'ordinary', 'sorcerer', 25, 1, 8, 0, 50, 100),
            ('sorcererEye', 'ordinary', 'sorcerer', 25, 1, 9, 0, 50, 100),
            ('sorcererBlaze', 'ordinary', 'sorcerer', 25, 1, 8, 0, 50, 100),
            ('rogueStab', 'ordinary', 'rogue', 26, 1, 7, 0, 50, 100),
            ('rogueHardness', 'ordinary', 'rogue', 27, 1, 8, 0, 50, 100),
            ('rogueStrike', 'ordinary', 'rogue', 27, 1, 9, 0, 50, 100),
            ('rogueKnock', 'ordinary', 'rogue', 27, 1, 8, 0, 50, 100);
